...
function Dashboard() {
  ...
  const [currentChallengeDateCreated, setCurrentChallengeDateCreated] =
    useState("");
  const [currentChallengeDateExpires, setCurrentChallengeDateExpires] =
    useState("");
          ...
          <div className={styles.overlayWrapper}>
            ...
            <Card containerWidth="70%" containerHeight="70%">
              <div className={styles.generalSpacing}>
                ...
                <BoldText text={currentChallengeName} />

                <BoldText text={currentChallengeDesc} />

                <BoldText text={currentChallengePoints} />

                <BoldText text={currentChallengeDateCreated} />

                <BoldText text={currentChallengeDateExpires} />
              </div>
              <div
                className={styles.communityPicContainer}
              ...
              >
                ...
                {isHovered && (
                  <Button
                    ...
                    variant="colorful"
                    className={styles.buttonInside}
                  />
                )}
                <input
                  type="file"
                  className={styles.communityPicFileInput}
            ...
            <div className={styles.leaderboardsCard}>
              <Card>
                <div className={styles.generalSpacing}>
                  ...
                  <Leaderboard
                    users={specificCompanyUsers.users}
