...
const CreateCommunity = () => {
  ...
  const handleAddChallenge = () => {
    setChallenges([
      ...challenges,
      { challengeDescription: "", points: 0, challengeName: "" },
    ]);
  };
    ...
    <div className={styles.createCredentialContainer}>
      ...
      >
        <div className={styles.createCommunityText}>
          <BoldText
            text={"Create Community (Basic Information) "}
        ...
        <div className={styles.generalSpacing}>
          <BoldText
            text={
              "Soulmynt will automatically send this membership token to people that join your community. Alternatively, choose to send this credential only when the user has reached a threshold of points"
            }
            containerWidth={"250px"}
            size={"15px"}
            textColor="#8F8F8F"
